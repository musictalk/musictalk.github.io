...
var _user$project$Model$QueryString = F3(
	function (a, b, c) {
		return {token: a, tokenType: b, expiration: c};
	});
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {flags: a, state: b, page: c};
	});
var _user$project$Model$SpotifyUserData = F2(
	function (a, b) {
...
var _user$project$Model$LoggedIn = F2(
	function (a, b) {
		return {ctor: 'LoggedIn', _0: a, _1: b};
	});
var _user$project$Model$GotToken = function (a) {
	return {ctor: 'GotToken', _0: a};
};
var _user$project$Model$Unlogged = {ctor: 'Unlogged'};
var _user$project$Model$SpotifyError = function (a) {
	return {ctor: 'SpotifyError', _0: a};
};
var _user$project$Model$SpotifyPlaylists = function (a) {
	return {ctor: 'SpotifyPlaylists', _0: a};
};
...
var _user$project$Model$ReceiveTracks = function (a) {
	return {ctor: 'ReceiveTracks', _0: a};
};
var _user$project$Model$LoadPlaylist = function (a) {
	return {ctor: 'LoadPlaylist', _0: a};
};
var _user$project$Model$SpotifyResponse = function (a) {
	return {ctor: 'SpotifyResponse', _0: a};
};
var _user$project$Model$QueryCachedToken = function (a) {
	return {ctor: 'QueryCachedToken', _0: a};
};
...
var _user$project$Spotify$decodePlaylists = A2(
	...
	A2(
		...
		'items',
		_elm_lang$core$Json_Decode$list(
			_user$project$Spotify$decodePlaylist(
				_elm_lang$core$Json_Decode$succeed(
					_elm_lang$core$Native_List.fromArray(
						[]))))));
var _user$project$Spotify$decodeUser = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Model$SpotifyUser,
	A3(
		_elm_lang$core$Json_Decode$object2,
		_user$project$Model$SpotifyUserData,
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(
				A2(_elm_lang$core$Json_Decode_ops[':='], 'url', _elm_lang$core$Json_Decode$string)))));
var _user$project$Spotify$performTask = function (token) {
	return A2(
		_elm_lang$core$Task$perform,
		function (x) {
			return _user$project$Model$SpotifyResponse(
				{
					ctor: '_Tuple2',
					_0: token,
					_1: _user$project$Model$SpotifyError(x)
				});
		},
		function (x) {
			return _user$project$Model$SpotifyResponse(
				{ctor: '_Tuple2', _0: token, _1: x});
		});
};
var _user$project$Spotify$get = F3(
	function (token, decoder, url) {
		var d = decoder;
		var request = {
			verb: 'GET',
			headers: _elm_lang$core$Native_List.fromArray(
...
var _user$project$Spotify$getSpotify = F3(
	function (token, decoder, url) {
		return A3(_user$project$Spotify$get, token, decoder, url);
	});
var _user$project$Spotify$getUserInfo = function (token) {
	return A2(
		_user$project$Spotify$performTask,
		token,
		A3(_user$project$Spotify$getSpotify, token, _user$project$Spotify$decodeUser, 'https://api.spotify.com/v1/me'));
};
var _user$project$Spotify$fetchListDetails = F3(
	function (token, userId, playlistId) {
		return A3(
			_user$project$Spotify$getSpotify,
			token,
			_user$project$Spotify$decodePlaylist(_user$project$Spotify$decodePlaylistTracks),
			A2(
				_elm_lang$core$Basics_ops['++'],
		...
		return A3(
			...
			function (_p2) {
				return _user$project$Model$ReceiveTracks(
					_elm_lang$core$Result$Err(_p2));
			},
			function (_p3) {
				return _user$project$Model$ReceiveTracks(
					_elm_lang$core$Result$Ok(_p3));
			},
			A3(_user$project$Spotify$fetchListDetails, token, userId, playlistId));
	});
var _user$project$Spotify$getPlaylists = function (token) {
	return A2(
		_user$project$Spotify$performTask,
		token,
		A3(_user$project$Spotify$getSpotify, token, _user$project$Spotify$decodePlaylists, 'https://api.spotify.com/v1/me/playlists'));
};
var _user$project$Spotify$loginUrl = function (returnUri) {
	var asd = A2(_elm_lang$core$Debug$log, 'loc', _elm_lang$navigation$Navigation$Location);
	return A2(
		_evancz$elm_http$Http$url,
		'https://accounts.spotify.com/authorize',
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'client_id', _1: '0775af0cec204cbf96932239352abd17'},
				{ctor: '_Tuple2', _0: 'response_type', _1: 'token'},
				{
				ctor: '_Tuple2',
				_0: 'redirect_uri',
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Copyright © musictalk 2016')
										]))
								])),
							A2(
							_elm_lang$html$Html$div,
										...
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html_Attributes$href('https://github.com/theor')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('discuss playlists')
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
...
var _user$project$Views$playlistSongUrl = F2(
	function (playlist, songId) {
		return A2(
			...
			A2(_elm_lang$core$Basics_ops['++'], '/song/', songId));
	});
			...
			return _elm_lang$core$List$concat(
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Views$viewPlaylist(p)
						]),
						_elm_lang$core$Native_Utils.eq(
						A2(_elm_lang$core$Basics_ops['%'], i + 1, 3),
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('clearfix visible-md-block visible-lg-block')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]) : _elm_lang$core$Native_List.fromArray(
						[]),
						_elm_lang$core$Native_Utils.eq(
						A2(_elm_lang$core$Basics_ops['%'], i + 1, 2),
						0) ? _elm_lang$core$Native_List.fromArray(
						[
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('clearfix visible-sm-block')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]) : _elm_lang$core$Native_List.fromArray(
					...
					[
						...
						function (_p0) {
							return A2(
								...
								A2(_elm_lang$core$List$indexedMap, mapPlaylist, _p0));
						}(playlists))
					]))
			]));
};
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id(song.id),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(song.name)
							])),
						A2(
						_elm_lang$html$Html$td,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(song.artist)
							])),
						A2(
						_elm_lang$html$Html$td,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(song.album)
							])),
						A2(
						_elm_lang$html$Html$td,
						_elm_lang$core$Native_List.fromArray(
...
var _user$project$Views$spotifyLoginView = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$html$Html_Attributes$class('btn navbar-btn')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Not connected')
		]));
var _user$project$Views$userProfile = function (model) {
	...
	if (_p2.ctor === 'LoggedIn') {
		...
		var imgSrc = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			_elm_lang$core$List$head(_p3.photo));
		return A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[]),
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Connect to Spotify')
								])),
							A2(
							_elm_lang$html$Html$p,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Link your account to display your playlists')
								])),
							A2(
							_elm_lang$html$Html$h3,
							_elm_lang$core$Native_List.fromArray(
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Attributes$src(_p7.image)
													]),
												_elm_lang$core$Native_List.fromArray(
													[])),
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text(_p7.name)
													])),
												A2(
												_elm_lang$html$Html$h3,
												_elm_lang$core$Native_List.fromArray(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text(_p7.owner)
													]))
											])),
										A2(
										_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('musictalk')
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
...
var _user$project$Routing$pageToData = F2(
	function (model, p) {
		var _p0 = A2(
			...
			{
				ctor: '_Tuple2',
				_0: _user$project$Model$dumpModel(model),
				_1: p
			});
		var _p1 = p;
		switch (_p1.ctor) {
			...
			case 'Playlist':
				...
				var _p4 = _p1._1;
				var _p2 = model.page;
				if (_p2.ctor === 'PlaylistDetails') {
					var _p3 = _p2._0;
					return _elm_lang$core$Native_Utils.eq(_p3.id, _p4) ? A2(_user$project$Model$PlaylistDetails, _p3, _p5) : A3(_user$project$Model$PlaylistReq, _p6, _p4, _p5);
				} else {
					return A3(_user$project$Model$PlaylistReq, _p6, _p4, _p5);
				}
			default:
				return A2(
...
var _user$project$Routing$pageParser = function () {
	...
	var match = function (x) {
		var l = A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, r, x);
		return _elm_lang$core$List$isEmpty(l) ? _elm_lang$core$Result$Err('no match') : A3(
			...
			function (l) {
				...
				if ((((_p7.ctor === '::') && (_p7._1.ctor === '::')) && (_p7._1._1.ctor === '::')) && (_p7._1._1._1.ctor === '[]')) {
					return _elm_lang$core$Result$Ok(
						{token: _p7._0, tokenType: _p7._1._0, expiration: _p7._1._1._0});
				} else {
	...
	A2(
		...
		A2(
			...
			A2(
				...
				_evancz$url_parser$UrlParser$s('playlist'),
				_evancz$url_parser$UrlParser$string))));
var _user$project$Routing$fromUrl = function (url) {
	return A3(
		...
		_evancz$url_parser$UrlParser$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					'',
					function (_p9) {
						return _elm_lang$core$Result$Ok(_user$project$Model$Index);
					})
				])),
		url);
};
var _user$project$Routing$urlParser = _elm_lang$navigation$Navigation$makeParser(
	function (_p10) {
		return _user$project$Routing$fromUrl(
			function (_) {
				return _.hash;
			}(_p10));
	});
var _user$project$Routing$toUrl = function (count) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#/',
...
var _user$project$Main$stateCmd = function (s) {
	...
	switch (_p0.ctor) {
		case 'GotToken':
			return _user$project$Spotify$getUserInfo(_p0._0);
		case 'LoggedIn':
...
var _user$project$Main$loadComments = _elm_lang$core$Native_Platform.outgoingPort(
	'loadComments',
	function (v) {
		return {
			id: v.id,
		...
		switch (_p2.ctor) {
			...
			case 'PlaylistReq':
				...
				var needFetchTracks = function () {
					var _p3 = model.page;
					if (_p3.ctor === 'PlaylistDetails') {
						return !_elm_lang$core$Native_Utils.eq(_p3._0.id, _p4);
					} else {
						return true;
					}
				}();
				return A2(_elm_lang$core$Debug$log, 'needFetchTracks', needFetchTracks) ? _elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$Spotify$getPlaylistTracks, token, _p2._0, _p4)
					]) : _elm_lang$core$Native_List.fromArray(
					[]);
			default:
				if (_p2._1.ctor === 'Just') {
					...
					return _elm_lang$core$Native_List.fromArray(
						[
							...
							A4(
								...
								A2(_user$project$Views$playlistSongUrl, _p5, _p6),
								_p6,
								1))
						]);
				} else {
...
var _user$project$Main$urlUpdate = F2(
	function (result, model) {
		var _p7 = _elm_lang$core$Basics$fst(
			A2(
				_elm_lang$core$Debug$log,
				'urlUpdate/model',
				{
			...
			switch (_p8.ctor) {
				...
				case 'LoggedIn':
					var m = _elm_lang$core$Native_Utils.update(
						model,
						{
							page: A2(_user$project$Routing$pageToData, model, _p9)
						});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						m,
						A2(
							...
							A2(_user$project$Main$pageCmd, _p8._0, m)));
				default:
					var m = _elm_lang$core$Native_Utils.update(
						model,
						{
...
var _user$project$Main$update = F2(
	function (msg, model) {
			...
			switch (_p11.ctor) {
				...
				case 'QueryCachedToken':
					...
					var m = _elm_lang$core$Native_Utils.update(
						model,
						{
							state: _user$project$Model$GotToken(_p12)
						});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						m,
						A2(
							_elm_lang$core$List_ops['::'],
							_user$project$Main$stateCmd(m.state),
							A2(_user$project$Main$pageCmd, _p12, m)));
				case 'SpotifyResponse':
					if (_p11._0.ctor === '_Tuple2') {
							...
							case 'SpotifyUser':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											state: A2(_user$project$Model$LoggedIn, _p11._0._0, _p11._0._1._0)
										}),
									_elm_lang$core$Native_List.fromArray(
							...
							case 'SpotifyPlaylists':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											page: _user$project$Model$IndexData(_p11._0._1._0)
										}),
									_elm_lang$core$Native_List.fromArray(
										[]));
							default:
								...
								if ((_p13.ctor === 'BadResponse') && (_p13._0 === 401)) {
									return {
										...
										_1: _user$project$Main$redirect(
											_user$project$Spotify$loginUrl(model.flags.location))
									};
								} else {
									return _elm_lang$core$Native_Utils.crashCase(
				...
				case 'ReceiveTracks':
					if (_p11._0.ctor === 'Ok') {
						var _p15 = A2(_elm_lang$core$Debug$log, 'ReceiveTracks model', model);
						var _p16 = model.page;
						if (_p16.ctor === 'PlaylistReq') {
							var model = _elm_lang$core$Native_Utils.update(
								model,
								{
									page: A2(_user$project$Model$PlaylistDetails, _p11._0._0, _p16._2)
								});
							var token = function () {
								...
								switch (_p17.ctor) {
									...
									default:
										return _elm_lang$core$Native_Utils.crashCase(
											'Main',
											{
												start: {line: 208, column: 41},
												end: {line: 211, column: 75}
											},
											_p17)('should have a token');
								}
							}();
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model,
								A2(_user$project$Main$pageCmd, token, model));
						} else {
							return _elm_lang$core$Native_Utils.crashCase(
								'Main',
								{
									start: {line: 206, column: 21},
									end: {line: 217, column: 46}
								},
								_p16)('WTF');
						}
					} else {
				...
				case 'LoadPlaylistComments':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$loadComments(_p11._0)
					};
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 174, column: 9},
				end: {line: 233, column: 43}
			},
			_p11)(
			_elm_lang$core$Basics$toString(msg));
	});
				...
				case 'LoginResult':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						{
							flags: flags,
							state: _user$project$Model$Unlogged,
							page: _user$project$Model$IndexData(
								_elm_lang$core$Native_List.fromArray(
									[]))
						},
						_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$answerToken = _elm_lang$core$Native_Platform.incomingPort('answerToken', _elm_lang$core$Json_Decode$string);
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$answerToken(_user$project$Model$QueryCachedToken);
};
